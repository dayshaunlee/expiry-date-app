...
For products like fresh vegetables, they may not necessarily have expiry dates but the date purchased can be tracked. This tool can be used by anyone storing food in their house. By using this tool, it saves time, money, and promotes safety.
...
- As a user, I want to be able to mark a food product as "_expired/unsafe to eat_"
- As a user, I want to be able to mark a food product as "_safe to eat_"
